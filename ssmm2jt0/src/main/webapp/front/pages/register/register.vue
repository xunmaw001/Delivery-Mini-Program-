<template>
	<view class="content">
		...
		<view v-if="tableName=='shangjia'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.dianpuming" type="text" class="uni-input" name="" placeholder="店铺名" />
		</view>
		<view v-if="tableName=='shangjia'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.dianpudizhi" type="text" class="uni-input" name="" placeholder="店铺地址" />
		</view>
		<view v-if="tableName=='shangjia'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.lianxiren" type="text" class="uni-input" name="" placeholder="联系人" />
		</view>
		<view v-if="tableName=='shangjia'" class="uni-form-item uni-column">
		...
		<view v-if="tableName=='shangjia'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.xiuxishijian" type="text" class="uni-input" name="" placeholder="休息时间" />
		</view>
		<view>
