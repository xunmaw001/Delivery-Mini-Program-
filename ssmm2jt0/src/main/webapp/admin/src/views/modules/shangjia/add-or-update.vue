        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shangjiatupian" label="商家图片" prop="shangjiatupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shangjiatupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="休息时间" prop="xiuxishijian">
          <el-input v-model="ruleForm.xiuxishijian" 
              placeholder="休息时间" clearable  :readonly="ro.xiuxishijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="休息时间" prop="xiuxishijian">
              <el-input v-model="ruleForm.xiuxishijian" 
                placeholder="休息时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shangjiajieshao = this.ruleForm.shangjiajieshao.replace(reg,'../../../ssmm2jt0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
