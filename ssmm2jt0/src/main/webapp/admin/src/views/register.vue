  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.22);borderRadius:10px">
        <h1 class="h1" style="color:rgba(104, 223, 240, 1);fontSize:28px;">外卖小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="商家名称" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangjiamingcheng" autocomplete="off" placeholder="商家名称" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.dianpuming" class="input" type="text" placeholder="店铺名">
			   </div>
			 </div> -->
			<el-form-item label="店铺名" class="input" v-if="tableName=='shangjia'">
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.lianxifangshi" autocomplete="off" placeholder="联系方式" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.xiuxishijian" class="input" type="text" placeholder="休息时间">
			   </div>
			 </div> -->
			<el-form-item label="休息时间" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.xiuxishijian" autocomplete="off" placeholder="休息时间" type="text" />
			</el-form-item>
